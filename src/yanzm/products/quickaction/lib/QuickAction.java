...
public class QuickAction extends PopupWindowForQuickAction {
    ...
    private void showButtonStyle() {
        ...
        int yPos = anchorRect.centerY() - rootHeight;
     ...
     * @param isOnTop flag to indicate where the popup should be displayed. Set
     *            TRUE if displayed on top of anchor and vice versa
     */
